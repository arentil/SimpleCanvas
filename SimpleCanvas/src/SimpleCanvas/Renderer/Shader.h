...
public:
    ...
    void uploadUniformFloat2(std::string const& name, scmath::Vec2 const& v) const;
    void uploadUniformFloat3(std::string const& name, scmath::Vec3 const& v) const;
    void uploadUniformFloat4(std::string const& name, scmath::Vec4 const& v) const;
    void uploadUniformMat4(std::string const& name, scmath::Mat4 const& m) const;
private:
