...
: _filePath(filePath)
{
    ...
    glTextureParameteri(_rendererId, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);     // interpolated
    glTextureParameteri(_rendererId, GL_TEXTURE_MAG_FILTER, GL_LINEAR);    // nearest neighbor
